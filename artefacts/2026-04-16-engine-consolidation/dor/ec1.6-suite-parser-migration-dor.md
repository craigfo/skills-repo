...
## Definition of Ready: Migrate src/suite-parser/ → cli/src/engine/suite/

**Story reference:** `artefacts/2026-04-16-engine-consolidation/stories/ec1.6-suite-parser-migration.md`
**Test plan reference:** `artefacts/2026-04-16-engine-consolidation/test-plans/ec1.6-suite-parser-migration-test-plan.md`
**Verification script reference:** `artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.6-suite-parser-migration-verification.md`
...
**Contract proposal:** `artefacts/2026-04-16-engine-consolidation/dor/ec1.6-suite-parser-migration-dor-contract.md`
...
✅ **Contract review passed** — proposed implementation aligns with all 6 ACs. See `ec1.6-suite-parser-migration-dor-contract.md` for the negotiated contract proposal (components, scope boundary, per-AC test approach, assumptions, touch points).
...
Proceed: Yes
Story: Migrate src/suite-parser/ → cli/src/engine/suite/ — artefacts/2026-04-16-engine-consolidation/stories/ec1.6-suite-parser-migration.md
Test plan: artefacts/2026-04-16-engine-consolidation/test-plans/ec1.6-suite-parser-migration-test-plan.md
Verification script: artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.6-suite-parser-migration-verification.md

Goal:
Move every file under src/suite-parser/ into cli/src/engine/suite/ via git mv (preserving
history). Move the associated test file(s) (.github/scripts/check-suite.js)
into cli/tests/engine/suite/. Rewrite any imports inside the moved tests from the old
...
- src/suite-parser/** → cli/src/engine/suite/** (git mv — 1 subfile: index.js)
- .github/scripts/check-suite.js → cli/tests/engine/suite/check-suite.js (git mv)
...
- New test file: cli/tests/engine/suite/migration-invariants.test.ts (5 assertions per test plan unit section)

Out of scope for this story (do not touch):
- Any behaviour change to suite-parser
