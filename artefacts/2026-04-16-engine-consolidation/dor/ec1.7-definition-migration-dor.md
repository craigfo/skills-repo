...
## Definition of Ready: Migrate src/definition-skill/ → cli/src/engine/story/

**Story reference:** `artefacts/2026-04-16-engine-consolidation/stories/ec1.7-definition-migration.md`
**Test plan reference:** `artefacts/2026-04-16-engine-consolidation/test-plans/ec1.7-definition-migration-test-plan.md`
**Verification script reference:** `artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.7-definition-migration-verification.md`
...
**Contract proposal:** `artefacts/2026-04-16-engine-consolidation/dor/ec1.7-definition-migration-dor-contract.md`
...
✅ **Contract review passed** — proposed implementation aligns with all 6 ACs. See `ec1.7-definition-migration-dor-contract.md` for the negotiated contract proposal (components, scope boundary, per-AC test approach, assumptions, touch points).
...
Proceed: Yes
Story: Migrate src/definition-skill/ → cli/src/engine/story/ — artefacts/2026-04-16-engine-consolidation/stories/ec1.7-definition-migration.md
Test plan: artefacts/2026-04-16-engine-consolidation/test-plans/ec1.7-definition-migration-test-plan.md
Verification script: artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.7-definition-migration-verification.md

Goal:
Move every file under src/definition-skill/ into cli/src/engine/story/ via git mv (preserving
history). Move the associated test file(s) (tests/check-definition-skill.js, tests/check-definition-skill.test.js)
into cli/tests/engine/story/. Rewrite any imports inside the moved tests from the old
...
- src/definition-skill/** → cli/src/engine/story/** (git mv — 1 subfile: helpers.js)
- tests/check-definition-skill.js, tests/check-definition-skill.test.js → cli/tests/engine/story/check-definition-skill.js, check-definition-skill.test.js (git mv)
...
- New test file: cli/tests/engine/story/migration-invariants.test.ts (5 assertions per test plan unit section)

Out of scope for this story (do not touch):
- Any behaviour change to definition-skill
