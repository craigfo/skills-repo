...
## Definition of Ready: Migrate src/improvement-agent/ → cli/src/agents/improvement-agent/

**Story reference:** `artefacts/2026-04-16-engine-consolidation/stories/ec1.2-improvement-agent-migration.md`
**Test plan reference:** `artefacts/2026-04-16-engine-consolidation/test-plans/ec1.2-improvement-agent-migration-test-plan.md`
**Verification script reference:** `artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.2-improvement-agent-migration-verification.md`
...
**Contract proposal:** `artefacts/2026-04-16-engine-consolidation/dor/ec1.2-improvement-agent-migration-dor-contract.md`
...
✅ **Contract review passed** — proposed implementation aligns with all 6 ACs. See `ec1.2-improvement-agent-migration-dor-contract.md` for the negotiated contract proposal (components, scope boundary, per-AC test approach, assumptions, touch points).
...
Proceed: Yes
Story: Migrate src/improvement-agent/ → cli/src/agents/improvement-agent/ — artefacts/2026-04-16-engine-consolidation/stories/ec1.2-improvement-agent-migration.md
Test plan: artefacts/2026-04-16-engine-consolidation/test-plans/ec1.2-improvement-agent-migration-test-plan.md
Verification script: artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.2-improvement-agent-migration-verification.md

Goal:
Move every file under src/improvement-agent/ into cli/src/agents/improvement-agent/ via git mv (preserving
history). Move the associated test file(s) (tests/check-improvement-agent.js, tests/check-challenger.js, tests/failure-detector.test.js, tests/failure-detector.integration.test.js)
into cli/tests/agents/improvement-agent/. Rewrite any imports inside the moved tests from the old
...
- src/improvement-agent/** → cli/src/agents/improvement-agent/** (git mv — 3 subfiles: failure-detector.js, challenger.js, trace-interface.js)
- tests/check-improvement-agent.js, tests/check-challenger.js, tests/failure-detector.test.js, tests/failure-detector.integration.test.js → cli/tests/agents/improvement-agent/check-improvement-agent.js, check-challenger.js, failure-detector.test.js, failure-detector.integration.test.js (git mv)
...
- New test file: cli/tests/agents/improvement-agent/migration-invariants.test.ts (5 assertions per test plan unit section)

Out of scope for this story (do not touch):
- Any behaviour change to improvement-agent
