...
## Definition of Ready: Migrate src/bitbucket-cloud-validator/ → cli/src/adapters/bitbucket/cloud/

**Story reference:** `artefacts/2026-04-16-engine-consolidation/stories/ec1.4-bitbucket-cloud-migration.md`
**Test plan reference:** `artefacts/2026-04-16-engine-consolidation/test-plans/ec1.4-bitbucket-cloud-migration-test-plan.md`
**Verification script reference:** `artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.4-bitbucket-cloud-migration-verification.md`
...
**Contract proposal:** `artefacts/2026-04-16-engine-consolidation/dor/ec1.4-bitbucket-cloud-migration-dor-contract.md`
...
✅ **Contract review passed** — proposed implementation aligns with all 6 ACs. See `ec1.4-bitbucket-cloud-migration-dor-contract.md` for the negotiated contract proposal (components, scope boundary, per-AC test approach, assumptions, touch points).
...
Proceed: Yes
Story: Migrate src/bitbucket-cloud-validator/ → cli/src/adapters/bitbucket/cloud/ — artefacts/2026-04-16-engine-consolidation/stories/ec1.4-bitbucket-cloud-migration.md
Test plan: artefacts/2026-04-16-engine-consolidation/test-plans/ec1.4-bitbucket-cloud-migration-test-plan.md
Verification script: artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.4-bitbucket-cloud-migration-verification.md

Goal:
Move every file under src/bitbucket-cloud-validator/ into cli/src/adapters/bitbucket/cloud/ via git mv (preserving
history). Move the associated test file(s) (tests/check-bitbucket-cloud.js)
into cli/tests/adapters/bitbucket/cloud/. Rewrite any imports inside the moved tests from the old
...
- src/bitbucket-cloud-validator/** → cli/src/adapters/bitbucket/cloud/** (git mv — 1 subfile: index.js)
- tests/check-bitbucket-cloud.js → cli/tests/adapters/bitbucket/cloud/check-bitbucket-cloud.js (git mv)
...
- New test file: cli/tests/adapters/bitbucket/cloud/migration-invariants.test.ts (5 assertions per test plan unit section)

Out of scope for this story (do not touch):
- Any behaviour change to bitbucket-cloud-validator
