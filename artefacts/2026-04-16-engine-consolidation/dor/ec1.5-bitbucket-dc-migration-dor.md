...
## Definition of Ready: Migrate src/bitbucket-dc-validator/ → cli/src/adapters/bitbucket/dc/

**Story reference:** `artefacts/2026-04-16-engine-consolidation/stories/ec1.5-bitbucket-dc-migration.md`
**Test plan reference:** `artefacts/2026-04-16-engine-consolidation/test-plans/ec1.5-bitbucket-dc-migration-test-plan.md`
**Verification script reference:** `artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.5-bitbucket-dc-migration-verification.md`
...
**Contract proposal:** `artefacts/2026-04-16-engine-consolidation/dor/ec1.5-bitbucket-dc-migration-dor-contract.md`
...
✅ **Contract review passed** — proposed implementation aligns with all 6 ACs. See `ec1.5-bitbucket-dc-migration-dor-contract.md` for the negotiated contract proposal (components, scope boundary, per-AC test approach, assumptions, touch points).
...
Proceed: Yes
Story: Migrate src/bitbucket-dc-validator/ → cli/src/adapters/bitbucket/dc/ — artefacts/2026-04-16-engine-consolidation/stories/ec1.5-bitbucket-dc-migration.md
Test plan: artefacts/2026-04-16-engine-consolidation/test-plans/ec1.5-bitbucket-dc-migration-test-plan.md
Verification script: artefacts/2026-04-16-engine-consolidation/verification-scripts/ec1.5-bitbucket-dc-migration-verification.md

Goal:
Move every file under src/bitbucket-dc-validator/ into cli/src/adapters/bitbucket/dc/ via git mv (preserving
history). Move the associated test file(s) (tests/check-bitbucket-dc.js, tests/check-bitbucket-dc-auth.test.js)
into cli/tests/adapters/bitbucket/dc/. Rewrite any imports inside the moved tests from the old
...
- src/bitbucket-dc-validator/** → cli/src/adapters/bitbucket/dc/** (git mv — 1 subfile: index.js)
- tests/check-bitbucket-dc.js, tests/check-bitbucket-dc-auth.test.js → cli/tests/adapters/bitbucket/dc/check-bitbucket-dc.js, check-bitbucket-dc-auth.test.js (git mv)
...
- New test file: cli/tests/adapters/bitbucket/dc/migration-invariants.test.ts (5 assertions per test plan unit section)

Out of scope for this story (do not touch):
- Any behaviour change to bitbucket-dc-validator
